 ...
 h=figure;
    ...
    legend('3 Tap ZF Equalized Simulation (Bit Error)', ...
        '3 Tap MMSE Equalized Simulation (Bit Error)',...
         '3 Tap MMSE-DFE Equalized Simulation (Bit Error)',...
...
ne_bpsk_2 =  [0.0910,0.0670,0.0570,0.0390,0.0260,0.0180,0.0080,0.0060,0.0030,0.0010,0,0,0,0];
 ...
 h=figure;
    ...
    legend('5 Tap ZF Equalized Simulation (Bit Error)', ...
         '5 Tap MMSE Equalized Simulation (Bit Error)',...
        '5 Tap MMSE-DFE Equalized Simulation (Bit Error)','Simulation (Bit Error)','Theory (Bit Error)','Location','SouthWest');
    % save the BER graph
...
ne_bpsk_3 = [0.0960,0.0750,0.0640,0.0430,0.0210,0.0090,0.01301,0.0050,0.0080,0.0030,0,0,0,0];
 ...
 h=figure;
    ...
    legend('3 Tap ZF Equalized Simulation (Bit Error)', ...
        '3 Tap MMSE Equalized Simulation (Bit Error)',...
        '3 Tap MMSE-DFE Equalized Simulation (Bit Error)','Simulation (Bit Error)','Theory (Bit Error)','Location','SouthWest');
    % save the BER graph
...
ne_qpsk_1 = [0.30732,0.26130,0.2252,0.1660,0.1408,0.0940,0.06802,0.05442,0.02961,0.0136,0.00720,0.0020,0.0016,0.0008];
 ...
 h=figure;
    ...
    legend('3 Tap ZF Equalized Simulation (Symbol Error)', ...
        '3 Tap MMSE Equalized Simulation (Symbol Error)',...
        '3 Tap MMSE-DFE Equalized Simulation (Symbol Error)','Simulation (Symbol Error)','Theory (Symbol Error)','Location','SouthWest');
    % save the BER graph
...
ne_qpsk_2 = [0.31252,0.25130,0.2324,0.1824,0.1456,0.104041,0.075630,0.0548219,0.03441,0.020808,0.01240,0.00760,0.00320,0.00160];
 ...
 h=figure;
    ...
    legend('5 Tap ZF Equalized Simulation (Symbol Error)', ...
        '5 Tap MMSE Equalized Simulation (Symbol Error)',...
        '5 Tap MMSE-DFE Equalized Simulation (Symbol Error)','Simulation (Symbol Error)','Theory (Symbol Error)','Location','SouthWest');
    % save the BER graph
